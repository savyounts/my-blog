...
layout: post
title:      "Local Storage "
date:       2018-11-01 03:48:06 +0000
permalink:  local_storage
---
...
Before HTML 5, application data had to be stored in cookies, included wiht every server request, but now with web storage, web application can store data locally within the user's browser without affecting website performance. HTML web storage provides two objects for storing data on the client: localStorage and sessionStorage. 
